    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# NOR gate: Manual testing with two pushbuttons and one LED\n\nThe LED is only on when none of the butons is pressed",
            "readonly": true
          },
          "position": {
            "x": 280,
        ...
        {
          "id": "e4435cf5-08c9-4ca6-bd0e-6e614e9f262e",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "e4435cf5-08c9-4ca6-bd0e-6e614e9f262e",
